...
3. Create the task in held/backlog state:
   `cd "{repo}" && mung --agent code task {taskname} --hold`
...
5. Stop after writing the partial spec. Do not run planning, build, or `mung finish`.

999. NO QUESTIONS.
9999. NO SPECULATION - ONLY CONFIRMED DETAILS.
99999. SUBMIT HOLD TASK ONLY - DO NOT START SPECS OR PLANNING.
999999. DO NOT call `mung finish` in this flow.
