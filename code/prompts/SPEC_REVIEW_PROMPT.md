...
5. Use this to signal next stage only if you can resolve all of the issues: `cd "{repo}" && METAGENT_TASK="{task}" metagent --agent code finish spec-review`
