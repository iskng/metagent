...
6. Research codebase exhaustively before generating tasks - use subagents liberally.
...
9999999999. Allowed parallelism: Codebase search up to 100 subagents, file reading up to 100 subagents, plan.md updates 1 subagent.
