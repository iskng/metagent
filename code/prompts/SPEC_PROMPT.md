...
2. After each set of answers spawn subagents to research the codebase or search online. Make sure to clarify any key decisions that you are not sure about. Document answers immediately in working notes.md
...
5. Use subagents (up to 50 parallel) to explore codebase. Find: APIs called/exposed, modules imported/importing, shared types, database tables, external services. Analyze: error handling patterns, logging patterns, testing patterns, validation patterns, naming conventions, similar implementations.
