...
4. Once you understand the problem, scope, boundaries, and key requirements, create the task using: cd "{repo}" && mung --agent code task {taskname} this will create the .agents/code/tasks/{taskname}/spec/ dir for you.
